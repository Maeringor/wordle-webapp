    ...
    <section class="basic-padding">
        ...
        <div class="faq-cards-container">
            ...
            <div class="single-faq-card light-blue-bg">
                ...
                <div class="text-content paragraph secondary-textcol">
                    Choose one of the game modes you would like to play. In each mode you have to guess a word that has five letters. After each attempt of a word you will get feedback about your attempt.<br>
                    There are three states of a letters.
                    <br>
                    1. the letter glows green, which means that the letter is in the right place.
                    <br>
                    2. the letter is orange, which means that the letter is in the word, but in the wrong position.
                    <br>
                    3. the letter is red, which means that the letter is not in the word at all.
                    <br><br>
        ...
        <div class="single-faq-card light-blue-bg">
            ...
            <br>Every submitted word will be checked before it will be added to the word collection, so the playability is guaranteed.
            </div>
        </div>
        <!-- single card end -->
